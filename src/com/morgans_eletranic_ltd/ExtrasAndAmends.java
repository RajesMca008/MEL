...
public class ExtrasAndAmends  extends BaseActivity {
	...
	public void initControls() {
		act = ExtrasAndAmends.this;
		layout = (RelativeLayout) inflater.inflate(R.layout.extrasa_aments, null);
		...
		materialListView.setOnTouchListener(new ListView.OnTouchListener() {
		        @Override
	...
	class LabourAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup arg2) {
			...
			tv__labour_price_type.setText(addLabourList.get(position).getPriceType());
			...
			addLabourList.get(position).setMargin(addLabourList.get(position).getMargin());
			//Invalid values
	...
	Activity act = ExtrasAndAmends.this;
